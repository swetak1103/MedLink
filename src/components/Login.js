      ...
      <section class="bg-gray-50 h-[80vh] flex items-center justify-center">
          ...
          <div class="md:w-[25vw] px-8 md:px-16">
            ...
            <form action="" class="flex flex-col gap-4" onSubmit={handleSubmit}>
              <input
                class="ml-[-10px]
        px-1 text-black
         h-8 text-sm p-2 w-[16vw] mt-8 rounded-xl border"
                type="email"
                value={email}
            ...
            <path d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5zM4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0z" />
              ...
              <button class="bg-[#002D74] mx-[65px] w-[6vw] rounded-xl text-white py-2 hover:scale-105 duration-300">
                Login
              </button>
            </form>
        ...
        <a href="#">Forgot your password?</a>
            ...
            <div class="mt-3 w-[17vw] text-xs flex justify-between items-center text-[#002D74]">
              ...
              <button
                onClick={register}
                class="py-2 mx-[16px] px-5 bg-white border rounded-xl hover:scale-110 duration-300"
              >
                Register
              </button>
            </div>
